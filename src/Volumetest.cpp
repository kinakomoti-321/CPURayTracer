...
#include "integrator/volume_homo_render.hpp"
...
int main()
{
    ...
    auto sphere6 = std::make_shared<Sphere>(Vec3(0.0, 200, 0.0), 60.0f);
    auto sphere7 = std::make_shared<Sphere>(Vec3(0.0, 16, 0.0), 16.0f);
    ...
    auto lit1 = std::make_shared<Light>(Vec3(1.0), 12.0);
    auto vol1 = std::make_shared<HomoVolume>(0.1f, 1.5f, 0.8f, Vec3(0.0f));
    ...
    auto obj5 = std::make_shared<Object>(sphere5, mat9, nullptr, vol1);

    auto tests = std::make_shared<Object>(sphere7, mat4, nullptr, vol1);
    auto testL = std::make_shared<Object>(sphere6, mat4, lit1);
    ...
    // if (obj4->hasVolume()) std::cout << "vol" << std::endl;
    // scene.addObject(obj5);
    scene.addObject(tests);
    scene.addObject(testL);
