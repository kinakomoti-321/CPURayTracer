...
int main()
{
    ...
    auto mat6 = std::make_shared<Glass>(Vec3(0.9), 1.5f);
    ...
    auto obj2 = std::make_shared<Object>(sphere2, mat6);
    // auto obj3 = std::make_shared<Object>(sphere3, mat6);
    auto obj4 = std::make_shared<Object>(sphere4, mat7);
    auto obj5 = std::make_shared<Object>(sphere5, mat9);
    ...
    Scene scene(std::make_shared<Sky>(Vec3(0.0f)), std::make_shared<Sphere>(Vec3(1.0), 1000.0f));
    ...
    Renderer renderer(width, height, normalcheck, camera);
    renderer.render(scene, 100, "GGXmis_50_1sec", sampler);
